...
public abstract class Controller
{
    ...
    /// 判断文件是否存在
    /// </summary>
    protected bool IsFileExists(string fileName)
    {
    ...
    /// 判断文件夹是否存在
    /// </summary>
    protected bool IsDirectoryExists(string fileName)
    {
    ...
    protected void SetData(string fileName, object pObject)
    {
        //将对象序列化为字符串
    ...
    protected object GetData(string fileName, Type pType)
    {
